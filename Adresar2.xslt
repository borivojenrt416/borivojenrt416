...
>
  ...
  <xsl:template match="i:Kompanija">
    <xsl:if test="i:Adresa[@tip='stalna'] or string-length(i:Naziv)>6">
      <tr>
        <td>
  ...
  <xsl:template match="i:Osoba">
    <xsl:if test="(i:Adresa[@tip='stalna'] and (i:DatumRođenja/i:Godina&gt;1990 and i:DatumRođenja/i:Godina&lt;2005)) or starts-with(i:PunoIme/i:Prezime,'M')">
    <tr>
